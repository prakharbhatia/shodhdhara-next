          ...
          <div>
            ...
            <div className="space-y-3 text-base text-black">
              <p>
                ...
                <br />
                <a href="tel:+919415592698" className="hover:underline transition-colors">+91-9415592698</a>
              </p>
              <p>
                ...
                <br />
                <a href="tel:+919450109471" className="hover:underline transition-colors">+91-9450109471</a>
              </p>
              <p>
                <strong className="text-black">Co-Editor:</strong>
                <br />
                Dr. Shravan Kumar Tripathi
                <br />
                <a href="tel:+918840259163" className="hover:underline transition-colors">+91-8840259163</a>
              </p>
              <p>
                <a
