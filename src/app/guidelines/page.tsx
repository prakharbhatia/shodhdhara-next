...
export const metadata: Metadata = {
  title: {
    absolute: "Author Guidelines | Shodh Dhara — Submission & Publication Policies",
  },
  description:
    "Author guidelines and publication policy for Shodh Dhara Research Journal ISSN 0975-3664. Learn submission criteria, paper formatting, peer review process, and declaration requirements for Arts & Humanities research.",
  alternates: { canonical: "https://shodhdhara.com/guidelines/" },
  openGraph: {
    type: "website",
    locale: "en_IN",
    siteName: "Shodh Dhara",
    title: "Author Guidelines | Shodh Dhara Research Journal",
    description:
      "Author guidelines for Shodh Dhara Research Journal ISSN 0975-3664. Learn submission criteria, paper formatting, peer review, and declaration for Arts & Humanities research.",
    images: [
      {
        url: "https://shodhdhara.com/logo.png",
        width: 512,
        height: 512,
        alt: "Shodh Dhara Author Guidelines",
      },
    ],
  },
  twitter: {
    ...
    title: "Author Guidelines | Shodh Dhara Research Journal",
    description:
      "Learn submission criteria, peer review process, and publication policy for Shodh Dhara Research Journal ISSN 0975-3664.",
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-primary mb-8 text-center sm:text-left">Editorial Guidelines</h2>
              ...
              >
                ...
                <ul className="space-y-2 ml-14">
                  {guideline.points.map((point, pIndex) => (
                    <li
                      key={pIndex}
                      className={`flex items-start gap-3 ${point.match(/[\u0900-\u097F]/) ? "hindi" : ""
                        }`}
                    >
