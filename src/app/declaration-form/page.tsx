...
export const metadata: Metadata = {
  title: {
    absolute: "Declaration Form | Shodh Dhara — Originality Declaration for Manuscripts",
  },
  description:
    "Download the Declaration Form for Shodh Dhara Research Journal submission. This originality declaration must be submitted with every research paper. Available as PDF.",
  alternates: { canonical: "https://shodhdhara.com/declaration-form/" },
  openGraph: {
    type: "website",
    locale: "en_IN",
    siteName: "Shodh Dhara",
    title: "Declaration Form | Shodh Dhara Research Journal",
    description:
      "Download the originality Declaration Form for Shodh Dhara Research Journal ISSN 0975-3664 submission.",
    images: [
      {
        url: "https://shodhdhara.com/logo.png",
        width: 512,
        height: 512,
        alt: "Shodh Dhara Declaration Form",
      },
    ],
  },
  twitter: {
    ...
    title: "Declaration Form | Shodh Dhara Research Journal",
    description:
      "Download the originality Declaration Form for Shodh Dhara ISSN 0975-3664 paper submission.",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-cream rounded-2xl p-8 sm:p-12 shadow-sm border border-gray-100 text-center">
            ...
            <p className="hindi text-slate leading-relaxed mb-8 max-w-2xl mx-auto">
              ...
              कहीं और प्रकाशित नहीं हुआ है, और किसी अन्य प्रकाशन
            </p>
            ...
            <p className="text-sm text-slate mt-6">
              Note: Please print, sign, and scan the form before submitting.
            </p>
          </div>
