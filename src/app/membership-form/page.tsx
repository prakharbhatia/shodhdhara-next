...
export const metadata: Metadata = {
  title: {
    absolute: "Membership Form | Shodh Dhara — Become a Member of Shodh Dhara Research Journal",
  },
  description:
    "Download the Membership Form for Shodh Dhara Research Journal ISSN 0975-3664. Become a member of this UGC Care Listed peer-reviewed Arts & Humanities journal. Enjoy quarterly issues and submission benefits.",
  alternates: { canonical: "https://shodhdhara.com/membership-form/" },
  openGraph: {
    type: "website",
    locale: "en_IN",
    siteName: "Shodh Dhara",
    title: "Membership Form | Shodh Dhara Research Journal",
    description:
      "Become a member of Shodh Dhara ISSN 0975-3664. UGC Care Listed peer-reviewed Arts & Humanities journal since 2005.",
    images: [
      {
        url: "https://shodhdhara.com/logo.png",
        width: 512,
        height: 512,
        alt: "Shodh Dhara Membership Form",
      },
    ],
  },
  twitter: {
    ...
    title: "Membership Form | Shodh Dhara Research Journal",
    description:
      "Become a member of Shodh Dhara ISSN 0975-3664. Download Membership Form.",
