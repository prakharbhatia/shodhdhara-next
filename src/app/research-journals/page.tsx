...
export const metadata: Metadata = {
  title: {
    absolute: "Research Journals | Importance of Peer-Reviewed Research in Academia | Shodh Dhara",
  },
  description:
    "How Shodh Dhara ISSN 0975-3664 contributes to peer-reviewed research in Arts & Humanities through rigorous double-blind peer review since 2005. Learn about the role of research journals in academia.",
  alternates: { canonical: "https://shodhdhara.com/research-journals/" },
  openGraph: {
    type: "website",
    locale: "en_IN",
    siteName: "Shodh Dhara",
    title: "Research Journals | Shodh Dhara — Peer-Reviewed Research",
    description:
      "Explore the importance of research journals in academic scholarship. How Shodh Dhara ISSN 0975-3664 contributes to peer-reviewed research since 2005.",
    images: [
      {
        url: "https://shodhdhara.com/logo.png",
        width: 512,
        height: 512,
        alt: "Shodh Dhara Research Journals",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Research Journals | Shodh Dhara",
    description:
      "Peer-reviewed research in Arts & Humanities since 2005. ISSN 0975-3664.",
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              <div className="w-14 h-14 bg-primary/10 rounded-xl flex items-center justify-center mb-6">
                <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.322 4.754 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-primary mb-3">
              ...
              <p className="hindi text-slate-dark leading-relaxed mt-3">
                पत्रिकाएं विद्वतापूर्ण कार्य के स्athaयी रिकॉर्ड के रूप में कार्य
                करती हैं, भविष्य की पीढ़ियों के लिए ज्ञान का संरक्षण करती हैं।
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="hindi text-slate-dark leading-relaxed mt-3">
                ...
                बढ़ावा देती हैं, शोधकर्ताओं के नेटवर्क का निर्माण करती हैं।
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="hindi text-slate-dark leading-relaxed mt-3">
                ...
                प्रोत्साहित करती हैं, मानव ज्ञान की सीमाओं को पलाती हैं।
              </p>
            </div>
          </div>
          ...
          <div className="bg-brand-gradient rounded-2xl p-8 sm:p-12 text-black">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                { en: "Open Access", hi: "खुली पहुंच" },
                { en: "Quick Publication", hi: "त्वरित प्रकाशन" },
