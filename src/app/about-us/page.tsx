...
export const metadata: Metadata = {
  title: {
    absolute: "About Us | Shodh Dhara — UGC Care Listed Quarterly Research Journal",
  },
  description:
    "Shodh Dhara (शोध धारा) is a UGC Care Listed Quarterly Peer Reviewed Research Journal in Arts & Humanities since 2005-06. Published by Shakshik Avam Anusandhan Sansthan, Orai (Jalaun), U.P. Discover our mission, vision, ISSN: 0975-3664.",
  alternates: { canonical: "https://shodhdhara.com/about-us/" },
  openGraph: {
    type: "website",
    locale: "en_IN",
    siteName: "Shodh Dhara",
    title: "About Shodh Dhara — Quarterly Research Journal",
    description:
      "Shodh Dhara is a UGC Care Listed quarterly peer-reviewed research journal in Arts & Humanities. Published since 2005 by Shakshik Avam Anusandhan Sansthan, Orai, U.P.",
    images: [
      {
        url: "https://shodhdhara.com/logo.png",
        width: 512,
        height: 512,
        alt: "Shodh Dhara Logo",
      },
    ],
  },
  twitter: {
    ...
    title: "About Shodh Dhara — Quarterly Research Journal",
    description:
      "UGC Care Listed quarterly peer-reviewed research journal in Arts & Humanities since 2005.",
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-cream rounded-2xl p-8 shadow-sm border border-gray-100 mb-10">
            <h2 className="text-2xl font-bold text-primary mb-3">About Shodh Dhara</h2>
            <div className="w-16 h-1 bg-gold rounded-full mb-6" />
            <div className="grid md:grid-cols-2 gap-6 text-black leading-relaxed">
              <p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-10">
            <div className="bg-brand-gradient rounded-2xl p-8 text-black">
              ...
              <p className="hindi text-black leading-relaxed mt-3 text-sm">
            ...
            <div className="bg-cream rounded-2xl p-8 border border-gray-100">
              ...
              <p className="hindi text-slate-dark leading-relaxed mt-3 text-sm">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <h3 className="text-xl font-bold text-primary mb-3">Journal At a Glance</h3>
            <div className="w-16 h-1 bg-gold rounded-full mb-5" />
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 divide-y sm:divide-y-0">
              {[
                ...
                { label: "Publisher", value: "Shaikshik Avam Anusandhan Sansthan" },
                ...
                <div key={item.label} className="flex items-center gap-3 py-2.5 border-b border-gray-100 last:border-0">
                  ...
                  <div className="flex justify-between items-baseline w-full gap-2">
                    <dt className="text-xs font-medium text-slate whitespace-nowrap">{item.label}</dt>
                    <dd className="text-xs font-semibold text-primary text-right">{item.value}</dd>
                  </div>
                </div>
              ))}
            </div>
